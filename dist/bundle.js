...
var _Spriter = __webpack_require__(/*! ../sprites/Spriter */ 315);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      this.character = new _Spriter2.default({
        game: this.game,
        name: 'character',
        x: 300,
        y: 300
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function preload() {
      ...
      _Spriter2.default.cache(this.load, 'character');
    }
  }, {
    key: 'create',
    value: function create() {
...
module.exports = __webpack_require__(/*! /Users/jlaing/Desktop/phaser/velda/code/src/main.js */119);
...
var Spriter = function () {
  ...
  _createClass(Spriter, [{
    ...
    value: function addSprite() {
      return this.game.add.sprite(this.startingPoint[0], this.startingPoint[1], this.name);
    }
  }, {
    key: 'addAnimations',
